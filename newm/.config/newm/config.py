...
panels = {
    ...
    "bottom_bar": {
        "native": {
            "enabled": False,
            "texts": lambda: ["newm-next", "version 0.4 ALPHA"],
        }
    },
}
